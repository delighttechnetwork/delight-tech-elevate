  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute top-40 -right-24 size-[420px] rounded-full bg-[var(--brand-2)] opacity-25 blur-3xl animate-float-slow" style={{ animationDelay: "-3s" }} />
        <div className="absolute bottom-0 left-1/3 size-[360px] rounded-full bg-[var(--brand)] opacity-20 blur-3xl animate-float-slow" style={{ animationDelay: "-6s" }} />
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 pt-12 md:pt-20 pb-24 md:pb-32 text-center">
        ...
        >
          ...
          <span className="text-muted-foreground">Premium tech & creative studio · Ibadan, Nigeria</span>
        </motion.div>
        ...
        >
          We design, build and maintain world-class digital products, branding and tech repair solutions for ambitious brands across Africa and beyond.
        </motion.p>
        ...
        >
          <Link to="/contact" className="group inline-flex items-center gap-2 rounded-full bg-gradient-brand px-6 py-3 text-sm font-medium text-white shadow-xl glow-ring hover:opacity-90 transition">
            Start a Project <ArrowRight className="size-4 group-hover:translate-x-1 transition" />
          </Link>
          <Link to="/portfolio" className="inline-flex items-center gap-2 rounded-full glass px-6 py-3 text-sm font-medium hover:text-primary transition">
            View Portfolio
          </Link>
        </motion.div>
