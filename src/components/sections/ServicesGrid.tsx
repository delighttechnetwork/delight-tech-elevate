    ...
    <section id="services" className="mx-auto max-w-7xl px-4 py-20 md:py-28">
      <Reveal className="max-w-2xl">
        ...
        <h2 className="mt-3 text-3xl md:text-5xl font-bold">
          A complete <span className="text-gradient">technology partner</span>
        </h2>
        <p className="mt-4 text-muted-foreground">
          From websites that perform to print that impresses and devices that work again — one
          trusted team, end to end.
        </p>
      </Reveal>
      ...
      {limit && (
        <div className="mt-10 text-center">
          <Link
            to="/services"
            className="inline-flex items-center gap-2 rounded-full glass px-6 py-3 text-sm font-medium hover:text-primary"
          >
