      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <Reveal>
          ...
          <h2 className="mt-3 text-3xl md:text-5xl font-bold">
            Built for brands that refuse to settle for ordinary.
          </h2>
          <p className="mt-5 text-muted-foreground leading-relaxed">
            Delight Tech Network is a Nigerian technology and creative studio headquartered in
            Ibadan. We combine engineering precision with design craft to ship products, identities
            and services that stand shoulder-to-shoulder with the world's best — at a price that
            respects African business realities.
          </p>
          <div className="mt-7 grid grid-cols-2 gap-4">
            {[
              { Icon: Rocket, t: "Fast Execution", d: "From brief to launch in days, not months." },
              {
                Icon: ShieldCheck,
                t: "Trusted Quality",
                d: "Production-grade work, every single time.",
              },
              {
                Icon: Users,
                t: "Human Partnership",
                d: "A team that listens, advises and shows up.",
              },
...
export function WhyUs() {
  const items = [
    {
      t: "World-class craft",
      d: "Every pixel, every line of code, every printed page held to international standards.",
    },
    {
      t: "End-to-end ownership",
      d: "Strategy, design, build, support — no hand-offs between agencies.",
    },
    { t: "Honest pricing", d: "Transparent quotes, no surprise invoices, flexible payment terms." },
    {
      t: "Always-on support",
      d: "Direct line to your project lead — no ticket queues or runarounds.",
    },
  ];
  return (
    <section className="bg-card/40 border-y border-border/60">
      <div className="mx-auto max-w-7xl px-4 py-20 md:py-28">
        <Reveal className="max-w-2xl">
          ...
          <h2 className="mt-3 text-3xl md:text-5xl font-bold">
            Four reasons clients <span className="text-gradient">stay</span>
          </h2>
        </Reveal>
          ...
          {items.map((it, i) => (
            <Reveal key={it.t} delay={i * 0.05}>
              <div className="rounded-2xl glass p-6 h-full">
                <div className="size-10 rounded-xl bg-gradient-brand text-white grid place-items-center font-bold">
                  {i + 1}
                </div>
...
export function FeaturedProjects() {
  const items = [
    {
      title: "Heritage Mall Web App",
      tag: "Web · CMS",
      grad: "from-[var(--brand)] to-[var(--brand-2)]",
    },
    {
      title: "Coacoa Souvenir Collection",
      tag: "Branding",
      grad: "from-[var(--brand-2)] to-pink-500",
    },
    {
      title: "TechFest Poster Series",
      tag: "Print Campaign",
      grad: "from-cyan-400 to-[var(--brand)]",
    },
  ];
  return (
    <section className="mx-auto max-w-7xl px-4 py-20 md:py-28">
      <Reveal className="flex items-end justify-between gap-6 flex-wrap">
        ...
        <Link to="/portfolio" className="rounded-full glass px-5 py-2.5 text-sm hover:text-primary">
          View all projects
        </Link>
      </Reveal>
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-20 md:py-28">
      <Reveal className="max-w-2xl">
        ...
        <h2 className="mt-3 text-3xl md:text-5xl font-bold">
          Trusted by businesses that <span className="text-gradient">demand more</span>
        </h2>
      </Reveal>
      ...
      <div className="grid lg:grid-cols-5 gap-12 items-center">
        <Reveal className="lg:col-span-2">
          <div className="relative">
            ...
            <div className="relative rounded-3xl overflow-hidden glow-ring">
              <img
                src={founder}
                alt={`Portrait of ${company.founder}, ${company.founderRole}`}
        ...
        <Reveal delay={0.1} className="lg:col-span-3">
          ...
          <p className="mt-6 text-muted-foreground leading-relaxed">
            ...
            technology and design at the same standard as anywhere else in the world. Under his
            leadership, the studio has grown from a one-man repair bench into a full-service
            technology partner trusted by retailers, fintechs, schools and creators across Nigeria.
          </p>
          <p className="mt-4 text-muted-foreground leading-relaxed">
            "We're not here to ship templates. We're here to make our clients look brilliant — and
            to make technology feel like the gift it was always meant to be."
          </p>
          <div className="mt-6 flex gap-3 flex-wrap">
            <Link
              to="/contact"
              className="rounded-full bg-gradient-brand px-5 py-2.5 text-sm font-medium text-white shadow-lg"
            >
              Work with John
            </Link>
            <Link
              to="/portfolio"
              className="rounded-full glass px-5 py-2.5 text-sm hover:text-primary"
            >
              See his work
            </Link>
          </div>
        ...
        <div className="relative overflow-hidden rounded-3xl p-10 md:p-16 text-center">
          ...
          <div className="relative text-white">
            ...
            <p className="mt-4 max-w-xl mx-auto opacity-90">
              Tell us about your project. We respond within one business hour.
            </p>
            <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
              <Link
                to="/contact"
                className="rounded-full bg-white text-foreground px-6 py-3 text-sm font-semibold hover:opacity-90"
              >
                Start a project
              </Link>
              <a
                href={`tel:${company.phone}`}
                className="rounded-full border border-white/40 px-6 py-3 text-sm font-medium hover:bg-white/10 inline-flex items-center gap-2"
              >
    ...
    <section className="mx-auto max-w-3xl px-4 py-20 md:py-28">
      ...
      <Reveal delay={0.1} className="mt-10">
        <Accordion
          type="single"
          collapsible
          className="rounded-2xl glass divide-y divide-border/60 px-2"
        >
          {faqs.map((f, i) => (
...
export function ContactBits() {
  return (
    <div className="grid sm:grid-cols-3 gap-4">
      <a
        href={`tel:${company.phone}`}
        className="rounded-2xl glass p-5 hover:text-primary transition"
      >
