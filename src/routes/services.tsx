  ...
  head: () => ({
    meta: [
      { title: "Services — Delight Tech Network" },
      {
        name: "description",
        content:
          "Web development, cyber security, UI/UX, graphics, print, souvenir branding and GSM repair services.",
      },
    ],
  }),
      ...
      <section className="mx-auto max-w-7xl px-4 pt-8 pb-16 text-center">
        <Reveal>
          ...
          <p className="mx-auto mt-5 max-w-2xl text-muted-foreground">
            Fifteen services. One trusted team. Pricing that scales with your ambition.
          </p>
        </Reveal>
      </section>
          ...
          >
            <div className={`lg:col-span-7 ${i % 2 ? "lg:order-2" : ""}`}>
              <div className="flex items-center gap-3">
                <span className="inline-grid place-items-center size-12 rounded-2xl bg-gradient-brand text-white shadow-lg">
            ...
            <div className={`lg:col-span-5 ${i % 2 ? "lg:order-1" : ""}`}>
              <div className="rounded-2xl glass p-6 text-center">
                ...
                <p className="mt-2 text-xs text-muted-foreground">
                  Custom quotes available for scope & scale.
                </p>
                <Link
                  to="/contact"
                  className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-full bg-gradient-brand px-5 py-3 text-sm font-medium text-white shadow-lg"
                >
